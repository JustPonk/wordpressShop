...
= 0.2 =
* Done Home page responsive.
* Added color settings.
* Resolved some minor issues.

= 0.2.1 =
* Resolved mobile menu close button error.
* Added customizer docs link.
...
* Resolved error of slider & scroll to top show/ hide does not work in responsive media settings.
* Added footer link.
* Resolved error of header overlapping when slider is off.
* Done BestSelling Product sec css of block pattern in responsive media.
* Done css of slider button in mobile media.
* Added icons & hover on a tag in metabox in blog page.
* Done css of coupan code.
* Done css of cart button.
* Done css of my account page.
* Done css of login page.
* Done css of checkout page.
* Done css of product title on Shop page & single product page.
* Resolved error of On loading screen product section, logo & are showing.
* Added global color of a tag hover of metabox.
* Done css of 404 page.
* Remove aligncenter class - border & padding from style.css
* Added link to customizer links in block pattern & gutenberg tab
* Done the css of link to customizer links in block pattern & gutenberg tab

= 0.2.2 =
* Added show / hide blog post time & single post time option in customizer.
* Changed get started tabs names.
* Checked logo and header image on other pages.
* Added hover on logo.
* Added global color for logo text.
...
* Done css of slider in responsive.
* Resolved issue of footer widget padding.
...
* Added open and close menu icon option in customizer.
* Updated language folder.
...
= 0.4.3 =
* Added show/hide option for slider title in customizer.
* Updated language folder.
...
= 0.4.7 =
* Added go pro button in slider, product and footer section in customizer.
...
* Add social icon setup steps in customizer.
...
* Add footer background option in customizer.
* Add option for date, categories & comment count in grid layout.
* Add option for shop page sidebar position in customizer.
* Updated language folder.
...
= 0.5.2 =
* Added related posts excerpt length option in customizer.
* Added blog post featured image option in customizer.
* Added menu item hover style option in customizer.
* Added post button letter spacing option in customizer.
* Added postdate, author, comments & time icon option in customizer.
* Added show/ hide related products.
* Updated language folder.

= 0.5.3 =
* Added menu section in customizer.
* Added menus text transfom in customizer.
* Added show/ hide post navigation option in customizer.
* Rearranged sections in customizer.
* Resolved error for menus font weight.
* Added footer background attatchment option in customizer.
* Updated language folder.

= 0.5.4 =
* Added single product gallery lightbox option.
* Added function for get started popup in function.php.
* Replace h1 to p tag in logo code.
* Added scroll to top icon option in customizer.
* Added scroll to top icon font size option in customizer.
* Added scroll to top icon padding option in customizer.
* Added scroll to top icon width option in customizer.
* Added scroll to top icon height option in customizer.
* Added scroll to top icon border radius option in customizer.
* Updated language folder.

= 0.5.5 =
* Added show/hide footer option in customizer.
* Added show/hide copyright option in customizer.
* Added copyright background color option in customizer.
* Added tgm license.
* Updated language folder.

= 0.5.6 =
* Added site title and site tagline color option in customizer.
* Added logo width option in customizer.
* Added logo height option in customizer.
* Added shop page featured image border radius option in customizer.
* Added shop page featured image box shadow option in customizer.
* Update language folder.

= 0.5.7 =
* Added option for date, author, comment icon option for grid layout.
* Added option for date, author, comment ,time icon option for single post layout.
* Added header background color option in customizer.
* Added preloader background image option in customizer.
* Update language folder.

= 0.5.8 =
* Added post sidebar layout section in post setting.
* Update language folder.

= 0.5.9 =
* Added footer background image position.
* Added pro in premium settings.
* Resolve error in font family.
* Update language folder.

= 0.6 =
* Resolved css error of single post sidebar in responsive media.
* Changed customizer setting name.
* Resolved css error pro setting name in customizer.
* Changed images of block pattern in get started.
* Added css in getstarted.
* Resolved css errors in block pattern.

= 0.6.1 =
* Resolved header image issue.
* Added header image background position option in customizer.
* Added meta separator in the grid layout for the customizer.
* Added 404 section in customizer.
* Added social icons section in customizer.
* Resolved css error in menus.
* Added css in sidebar for social icon.
* Update language folder. 

= 0.6.2 =
* Fixed the pagination issue on clearfloat page.
* Resolved blog post meta field seperator error.
* Added esc_attr in single-product.php and archive-product.php
* Resolved menu codition issues.
* Tested upto WP v6.3 

= 0.6.3 =
* Added css for pages.
* Resolved css for comment section.
* Added css for comment section.
* Resolved block image page css.
* Resolved block cover page css.
* Resolved block button page css.
* Resolved block gallery page css.
* Remove esc_url in content-page.php.
* Added fonts license information in readme file.
* Resolved error for tag in blog post.
* Added show/ hide pagination option for blog post in customizer.
* Added blog pagination option in customizer.

= 0.6.4 =
* Added css for block widgets sidebar.
* Added css for block widgets footer.
* Added vw about us widgets for sidebar.
* Added vw contact us widgets for sidebar.
* Added post navigation text in single post.
* Resolved layout elements page css.
* Changed homepage image in get started. 

= 0.6.5 =
* Added excerpt suffix in blog post.
* Added css for blog post pagination.
* Added classes in global color.
* Resolved blog post meta field seperator error in single post and grid layout.
* Added display grid posts option in customizer.
* Update pot file.

= 0.6.6 =
* Resolved doc link issue.

= 0.6.7 =
* Added css for grid layout.
* Resolve preview error.
* Added button text for grid layout.
* Added excerpt suffix in grid post.
* Added css for get started in woocommerce products addons tab.

= 0.6.8 =
* Resolved error in block pattern.
* Resolved sidebar issue in preview.
* Tested upto WP v6.4
* Resolved font family issue.
* Resolved preview issue.
* Update pot file.

= 0.6.9 =
* Resolved error for get started.
* Added slider button text option.
* Added slider button link option.
* Changed condition for show/hide slider in responsive media.
* Added cart and checkout page css.
* Resolved css error for block pattern.

= 0.7 =
* Resolved view cart css error.
* Resolved css error in responsive media.

= 0.7.1 =
* Resolved block pattern frontend error.

= 0.7.2 =
* Added css for view cart button.
* Added grid post content option in grid layout settings.
* Changed rtl css.
* Update pot file.

= 0.7.3 =
* Added category and search widgets for preview.

= 0.7.4 =
* Added default footer for preview.
* Added edit link in blog post.
...
* Added edit link in single post, related and grid post.
* Added search, dropdown categories , categories widgets for sidebar preview.
* Update pot file.

= 0.7.6 =
* Resolved slider button condition.
...
* Added classes in global color for checkout and cart page.
* Updated archive-product.php file.
* Resolved show / hide issue in single product.
...
= 0.8.1 =
* Added show /hide preloader for responsive setting.
* Updated pot file.
...
* Resolved cart page css in responsive media.
* Added css for proceed to checkout button in responsive media.
* Resolved copyright alignment issue.
* Added css for WooCommerce navigation.
* Resolved error for three and four post sidebar layout.

= 0.8.4 =
* Added theme bundle tab in get started.
* Resolved error for single post image.
* Resolved css error for footer calender.
...
* Added show/hide topbar header section.
* Added show/hide topbar in mobile media.
* Updated pot file.

== Resources ==

Florist Flower Shop WordPress Theme, Copyright 2020 VWThemes
Florist Flower Shop is distributed under the terms of the GNU GPL.
...
= Font-Awesome =
* Dave gandy
* Copyright (c) 2024 Fonticons, Inc. Dave gandy
...
== Fonts ==
* Poppins *
* Source : https://fonts.google.com/specimen/Poppins?query=Poppins

* Sail *
* Source : https://fonts.google.com/specimen/Sail?query=Sail

* Pxhere Images,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/license

Slider Image, Copyright Egor Kamelev
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1419243

Product Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/31512

Product Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/103396

Product Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/567753
...
Product Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/881857

Product Image, Copyright
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/599885

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-florist-flower-shop/
